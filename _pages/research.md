...
<div class="paper-block">
  ...
  <div class="paper-presentations" id="jmp-presentations">
    <div>UCSD Labor/Public Workshop, 2026 All-California Labor Economics Conference (poster), <em>(scheduled)</em> 2026 APPAM Annual Conference, 2026 NTA Annual Conference</div>
  </div>
</div>
...
<div class="paper-block">
  ...
  <div class="paper-meta"><em>Minor Revisions Requested, <strong>Management Science</strong></em></div>
  <div class="paper-buttons">
  ...
  <div class="paper-presentations" id="crowded-presentations">
    ...
    <div><em>By coauthor:</em> UCSD Labor/Public Workshop, 2025 WEAI Annual Conference</div>
  </div>
</div>
...
<div class="paper-block">
  ...
  <div class="paper-presentations" id="MWY-presentations">
    <div>UCSD Labor/Public Workshop, 2026 ASHEcon Annual Conference (poster), 2026 WEAI Annual Conference</div>
  </div>
</div>
...
<div class="paper-block">
  <div class="paper-title">Retirement Age Thresholds and the Economic Well-Being of Older Americans</div>
   <div class="paper-buttons">
    <button type="button" class="toggle-btn" aria-expanded="false" aria-controls="retirement-presentations" onclick="togglePanel('retirement-presentations', this)">Presentations</button>
  </div>
  <div class="paper-presentations" id="retirement-presentations">
    <div>UCSD Labor/Public Workshop</div>
  </div>
</div>
