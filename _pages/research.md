...
## Working Papers
**Crowded at Birth: Lasting Effects of Maternity Ward Crowding in California** [[Draft](https://dx.doi.org/10.2139/ssrn.5036978)] \
with [Yuli Xu](https://sites.google.com/view/yulixu-econ) (<span class="abstract-toggle" onclick="var el=document.getElementById('crowded-abstract'); el.style.display = el.style.display==='none' ? 'block' : 'none';">Abstract</span>)
